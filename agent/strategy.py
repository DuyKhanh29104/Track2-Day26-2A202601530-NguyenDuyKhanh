...
if __name__ == "__main__":
    ...
    # After the query-cost retune this ceiling is 9cr, so ten disciplined
    # rounds leave 10 credits of real headroom. Keep this executable example
    # aligned with the authoritative cost table instead of the older 11cr text.
